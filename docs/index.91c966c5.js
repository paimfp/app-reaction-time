...
const [hit$, miss$] = _rxjs.partition(_rxjs.fromEvent(_utils.gameArea, "click"), (e)=>e.target.classList.contains("dot")
);
hit$.pipe(_rxjs.tap(_utils.moveRandom), _rxjs.timeInterval(), _rxjs.scan(onHit, []), _rxjs.take(NUM_TRIES + 1)).subscribe({
    next: (next)=>{
        _utils.updateResults(next);
        _utils.setDotText(NUM_TRIES - next.length);
    },
    error: (error)=>{
    },
    complete: ()=>{
...
miss$.pipe(_rxjs.skipUntil(hit$), _rxjs.scan((err)=>++err
, 0), _rxjs.takeWhile(()=>_utils.isPlaying
)).subscribe({
    next: (err)=>_utils.updateError(err)
});
_utils.init();

},{"rxjs":"eIdcY","./utils":"5m6Az"}],"eIdcY":[function(require,module,exports) {
...
function repeat(countOrConfig) {
    ...
    return count <= 0 ? function() {
        ...
        var resubscribe = function() {
            ...
            sourceSub = null;
            if (delay != null) {
                var notifier = typeof delay === 'number' ? _timer.timer(delay) : _innerFrom.innerFrom(delay(soFar));
        ...
        var subscribeToSource = function() {
            var syncUnsub = false;
            sourceSub = source.subscribe(new _operatorSubscriber.OperatorSubscriber(subscriber, undefined, function() {
                if (++soFar < count) {
...
},{"../observable/empty":"aJbJE","../util/lift":"acAIF","./OperatorSubscriber":"2AV5Y","../observable/innerFrom":"8vUv0","../observable/timer":"6RyKL","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"6YiKQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5m6Az":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gameArea", ()=>gameArea
);
parcelHelpers.export(exports, "moveRandom", ()=>moveRandom
);
parcelHelpers.export(exports, "setDotText", ()=>setDotText
);
...
const centerDot = ()=>moveDot([
        areaCenter[0] - DOT_RADIUS / 2,
        areaCenter[1] - DOT_RADIUS / 2
    ])
;
const randomCoords = ()=>{
...
const moveRandom = ()=>moveDot(randomCoords())
;
const setDotText = (value)=>dot.innerText = value
;
let isPlaying = true;
const updateResults = (state)=>{
    let html = `Results:<br>Average:`;
    if (state.length) html = `Results: ${state.join("ms, ")}ms <br> Average: ${(state.reduce((x, y)=>x + y
    ) / state.length).toFixed(2)}ms`;
...
const endGame = ()=>{
    ...
    setDotText("Refresh");
    _rxjs.fromEvent(dot, "click").subscribe(()=>window.location.reload()
    );
};
